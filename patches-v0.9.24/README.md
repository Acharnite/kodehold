# agentmemory Patches — v0.9.24 (ARCHIVED)

> **⚠️ ARCHIVED:** These patches apply to agentmemory **v0.9.24 only**.
> v0.9.25 incorporates all upstream fixes — no dist patches needed.
> See `../patches/README.md` for current status.
>
