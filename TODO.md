...
- [ ] **Token budget tracking** — per team/phase with alerts when exceeded ([#6](https://github.com/Acharnite/kodehold/issues/6))
...
- [ ] **Memoir distillation at CLOSED** — ADR-0009 phase 4: Scribes should distill project memories into memoirs after each CLOSED transition. Currently manual ([#7](https://github.com/Acharnite/kodehold/issues/7))
